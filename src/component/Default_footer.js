            ...
            <div className={styles.FootContent}>
                <section className={styles.sectionTop}>
                    <section>
                        ...
                        <div id={styles.Btns}>
                            <a id={styles.appleBtn}>
                                <div><img src="/images/Apple_logo_black.svg.png"/>App Store</div>
                            </a>
                            <a id={styles.googleBtn}>
                                <div><img src="/images/play_store_logo.png"/>Google Play</div>
                            </a>
                        </div>
                    </section>
                    <nav>
                ...
                <section className={styles.infoBox}>
                    <section id={styles.info}>
                        ...
                        <section>
                            <a>이용약관</a>
                            <a id={styles.emphasis}>개인정보처리방침</a>
                            <a>위치기반서비스 이용약관</a>
                            <a>이용자보호 비전과 계획</a>
                        </section>
                    </section>
